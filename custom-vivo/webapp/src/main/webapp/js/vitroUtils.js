...
/* Add links to images in faculty lists */
$('li.individual div.adjImgHeight, li.individual img').live('click', function() {
    var goURL = $(this).next("h1").find( "a").attr('href');
    $(location).attr('href', goURL);
});

$('li.individual div.adjImgHeight, li.individual img').live( "mouseenter", function() {
