...
<#assign isDataType = editConfiguration.pageData.isDataType />
<#assign typeOfNew = editConfiguration.pageData.typeOfNew />
...
<h3>Hello</h3>
<p>isPersonType = ${isPersonType}</p>
<p>isDataType = ${isDataType}</p>
<p>typeOfNew = ${typeOfNew}</p>
